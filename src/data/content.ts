...
export const education = [
  ...
  },
  {
    ...
    subtitle: "Batch 36",
    duration: '2019 - 2020',
    description: 'Year-long Internship/Entrepreneurship Course in start-ups based in Silicon Valley. While working for a Silicon Valley startup, I was also enrolled in Stanford University, taking entrepreneurship courses under a non-graduating option.',
  },
  {
    image: CaptLogo,
...
export const work = [
  ...
  },
  {
    ...
    description: 'Steady is a lifestyle marketplace mobile application catered to the hearing impaired. The idea was first formulated during a hackathon, and then developed into a social enterprise.',
  },
...
export const projects = [
  ...
  },
  {
    ...
    description: 'Orbital is an independent software development project offered by NUS. Under this project, I developed a mobile application called InTheLoop – a student event planning and management system. This application is currently being adapted for use in CAPT.',
  },
  {
    image: Csc,
    ...
    description: 'The College Students’ Committee represents the college’s student body and addresses their needs. As the Director of Publicity, I oversaw dynamics of student life and managed publicity campaigns, materials and the corporate image of the College. I led a team of 22 student leaders and oversaw their personal development as well.',
  },
];
