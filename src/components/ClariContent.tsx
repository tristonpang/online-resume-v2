...
import {
  default as BdayPhoto,
  default as UmbrellaPhoto,
} from "../resources/images/claritris_umbrella_50.jpg";
  ...
  return (
    <Box className={styles.container}>
      ...
      <Section
        id="content"
        sectionTitle=""
        content={clariContent}
        useEssayCards
      />
      <Typography className={classes.psText}>
        {"(we also really like reflections)"}
      </Typography>
      <ImageGallery
        additionalClass={classes.gallery}
        items={reflectionImages}
        autoPlay
      />
    </Box>
  );
